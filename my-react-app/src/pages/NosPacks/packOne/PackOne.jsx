...
export default function HeroSection() {
  ...
  return (
    <div>
        <div className="relative h-[80vh] flex items-center justify-center overflow-hidden bg-white  mt-42">
      {/* Formes flottantes */}
      ...
      <div className={`text-center flex flex-col items-center  px-6 max-w-full transition-all duration-1000  ${isVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-10'}`}>
        ...
        <p className="text-gray-700 mb-8 text-center max-w-md leading-relaxed ">
          Découvrez des offres à petit prix et clés en main pour vous accompagner dans vos projets, tout en conservant une qualité de réalisation !
        </p>
